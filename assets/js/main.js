(function($) {
    ...
    $(".xsearch-trigger").on('click', function() {
    ...
    $(".request-trigger").on('click', function() {
        ...
        $('.frnd-request-listb').toggleClass('hide');
        $('.frnd-request-listc').toggleClass('hide');
    })

    $(".request-triggerb").on('click', function() {

        $('.frnd-request-list').toggleClass('hide');
        $('.frnd-request-listb').toggleClass('show');
        $('.frnd-request-listc').toggleClass('hide');
    })
    $(".request-triggerc").on('click', function() {

        $('.frnd-request-list').toggleClass('hide');
        $('.frnd-request-listb').toggleClass('hide');
        $('.frnd-request-listc').toggleClass('show');
    })
